    {{-- update user --}}
    <div class="modal fade" wire:ignore.self id="updateUser" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <form action=""  wire:submit.prevent='update({{ $edit_id }})'>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" wire:model.lazy='edit_phone' class="form-control">
